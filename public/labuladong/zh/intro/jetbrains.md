...
![](/images/algo/intro/jb-show.jpeg)
...
![](/images/algo/intro/set_jb_plugin.jpg)
...
![](/images/algo/intro/jb_cookie.jpg)
...
![](/images/algo/intro/copy-lc-cookie.jpg)
...
![](/images/algo/intro/jb-site-cookie.jpg)
...
![](/images/algo/intro/jb-refresh-vip-success.jpg)
...
![](/images/algo/intro/jb-clean-file-cache.jpg)
...
![](/images/algo/plugin-debug/jb-java-debug.jpg)
...
![](/images/algo/plugin-debug/config-jb-local-debug.jpg)
...
![](/images/algo/plugin-debug/jb-cpp-debug.jpg)

经过我的测试，当打开新的题目创建新的 cpp 代码文件时，IDE 不会自动刷新 cmake，会导致新的代码文件无法编译，需要在这里手动刷新 cmake：

![reload-cmake](/images/algo/plugin-debug/reload-cmake.png)

每次打开一道新的题目都要点击这个按钮手动刷新，有点麻烦。我们可以为它设置一个快捷键简化这个流程。

在 Clion 的设置页面搜索关键词 `cmake.reload` 即可进行设置：

![reload-cmake-shortcut](/images/algo/plugin-debug/reload-cmake-shortcut.png)
...
![](/images/algo/plugin-debug/jb-python-debug.jpg)
...
![](/images/algo/plugin-debug/jb-go-debug.jpg)
...
![](/images/algo/plugin-debug/jb-js-debug.jpg)
