...
本文是承接 [二叉树心法（纲领篇）](</zh/algo/essential-technique/binary-tree-summary/>) 的第二篇文章，先复述一下前文总结的二叉树解题总纲：
...
第一篇文章 [二叉树心法（思维篇）](</zh/algo/data-structure/binary-tree-part1/>) 讲了「遍历」和「分解问题」两种思维方式，本文讲二叉树的构造类问题。
...
![](/images/lc/uploads/2020/12/24/tree1.jpg)
...
![](/images/lc/uploads/2020/12/24/tree2.jpg)
...
![](/images/lc/uploads/2021/02/19/tree.jpg)
...
![](/images/algo/binary-tree-ii/2.jpeg)
...
![](/images/algo/binary-tree-ii/3.jpeg)
...
![](/images/algo/binary-tree-ii/4.jpeg)
...
CC++GoJavaJavaScriptPython
    ...
    class Solution {
        ...
        TreeNode build(int[] preorder, int preStart, int preEnd,
            ...
            // 先构造出当前根节点
            TreeNode root = new TreeNode(rootVal); ![](/images/algo/binary-tree-ii/4.jpeg)
            // 递归构造左右子树
            root.left = build(preorder, preStart + 1, preStart + leftSize,
                    inorder, inStart, index - 1);
...
![](/images/algo/binary-tree-ii/5.jpeg)
...
![](/images/algo/binary-tree-ii/6.jpeg)
...
CC++GoJavaJavaScriptPython
    ...
    class Solution {
        ...
        TreeNode build(int[] inorder, int inStart, int inEnd,
            ...
            // 左子树的节点个数
            int leftSize = index - inStart;
            TreeNode root = new TreeNode(rootVal); ![](/images/algo/binary-tree-ii/6.jpeg)
            // 递归构造左右子树
            root.left = build(inorder, inStart, index - 1,
                             postorder, postStart, postStart + leftSize - 1);
...
![](/images/algo/binary-tree-ii/7.png)
...
![](/images/algo/binary-tree-ii/8.jpeg)
...
CC++GoJavaJavaScriptPython
    ...
    class Solution {
        ...
        TreeNode build(int[] preorder, int preStart, int preEnd,
            ...
            // 先构造出当前根节点
            TreeNode root = new TreeNode(rootVal); ![](/images/algo/binary-tree-ii/8.jpeg)
            // 递归构造左右子树
