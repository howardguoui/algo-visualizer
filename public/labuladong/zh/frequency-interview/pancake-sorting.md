...
![diagram](https://labuladong.online/images/algo/pancakeSort/1.jpg)
...
如何解决这个问题呢？其实类似上篇文章 [递归反转链表的一部分](</zh/algo/data-structure/reverse-linked-list-recursion/>)，这也是需要**递归思想** 的。
