...
![diagram](https://labuladong.online/images/algo/changelog/vscode-viz-editor.jpg)
...
支持算法代码可视化： ![diagram](https://labuladong.online/images/algo/visualize_intro/vscode_example.jpg)

## v1.3.3

  * 多语言解法上面给出提示语，允许用户提交 pr 修正错误
  * 添加 `codeTemplate` 设置，允许用户自定义代码模板进行本地调试： ![diagram](https://labuladong.online/images/algo/intro/vscode-code-template.jpg)
