...
BobEve（监听）AliceBobEve（监听）Alice生成私钥 a=6生成私钥 b=15计算公钥A = 5^6 mod 23 = 8计算公钥B = 5^15 mod 23 = 19监听到 A=8监听到 B=19计算共享密钥s = 19^6 mod 23 = 2计算共享密钥s = 8^15 mod 23 = 2无法计算出 s！共享密钥 s=2共享密钥 s=2发送 A=8发送 B=19
