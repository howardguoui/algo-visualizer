...
**188\. 买卖股票的最佳时机 IV** |[力扣](<https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-iv/>)|[LeetCode](<https://leetcode.com/problems/best-time-to-buy-and-sell-stock-iv/>)
...
[动态规划核心套路](</zh/algo/essential-technique/dynamic-programming-framework/>) 说过，动态规划算法本质上就是穷举「状态」，然后在「选择」中选择最优解。
...
**122\. 买卖股票的最佳时机 II** |[力扣](<https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-ii/>)|[LeetCode](<https://leetcode.com/problems/best-time-to-buy-and-sell-stock-ii/>)
...
给定一个整数数组`prices`，其中第  __`prices[i]` 表示第 ` _i_` 天的股票价格 。​
...
这个疑问很正确，因为我们前文 [动态规划答疑篇](</zh/algo/dynamic-programming/faq-summary/>) 有介绍 `dp` 数组的遍历顺序是怎么确定的，主要是根据 base case，以 base case 为起点，逐步向结果靠近。
