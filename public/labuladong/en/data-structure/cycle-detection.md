...
![diagram](https://labuladong.online/images/algo/topological-sort/5-en.jpeg)

After initializing the queue, nodes with an in-degree of 0 are added first:

![diagram](https://labuladong.online/images/algo/topological-sort/6-en.jpeg)
...
![diagram](https://labuladong.online/images/algo/topological-sort/7-en.jpeg)

Continue popping nodes and decrementing neighbors' in-degrees. This time, no new zero-in-degree nodes are produced:

![diagram](https://labuladong.online/images/algo/topological-sort/8-en.jpeg)

Continue popping nodes and decrementing neighbors' in-degrees, adding newly zero-in-degree nodes to the queue:

![diagram](https://labuladong.online/images/algo/topological-sort/9-en.jpeg)

Keep popping nodes until the queue is empty:

![diagram](https://labuladong.online/images/algo/topological-sort/10-en.jpeg)
...
![diagram](https://labuladong.online/images/algo/topological-sort/11-en.jpeg)
...
![diagram](https://labuladong.online/images/algo/topological-sort/12-en.jpeg)
