...
> Source: https://labuladong.online/algo/en/frequency-interview/pancake-sorting/
...
![diagram](https://labuladong.online/images/algo/pancakeSort/1-en.jpg)

Think of flipping a stack of pancakes with a spatula. There is a rule: each time, you can only flip the top few pancakes.

![diagram](https://labuladong.online/images/algo/pancakeSort/2.png)
...
**969\. Pancake Sorting** |[LeetCode](<https://leetcode.com/problems/pancake-sorting/>)
...
The problem is from [LeetCode 969. Pancake Sorting](<https://leetcode.com/problems/pancake-sorting/>).

How do we solve this problem? Like in the article [Recursively Reverse Part of a Linked List](</en/algo/data-structure/reverse-linked-list-recursion/>), we need to use recursion.
...
![diagram](https://labuladong.online/images/algo/pancakeSort/3.jpg)

Now the problem size is smaller, so we can recursively call `pancakeSort(A, n-1)`:

![diagram](https://labuladong.online/images/algo/pancakeSort/4.jpg)
