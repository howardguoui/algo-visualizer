...
CC++GoJavaJavaScriptPython
    ...
    class Solution {
        ...
        void sort(int[] cakes, int n) {
            ...
            reverse(cakes, 0, n - 1);
            res.add(n); ![](/images/algo/pancakeSort/3.jpg)
            // recursive call
            sort(cakes, n - 1); ![](/images/algo/pancakeSort/4.jpg)
        }
