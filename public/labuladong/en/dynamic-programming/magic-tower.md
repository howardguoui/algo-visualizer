...
> Source: https://labuladong.online/algo/en/dynamic-programming/magic-tower/
...
**174\. Dungeon Game** |[LeetCode](<https://leetcode.com/problems/dungeon-game/>)
...
The problem is from [LeetCode 174. Dungeon Game](<https://leetcode.com/problems/dungeon-game/>).
...
This is the top-down dynamic programming solution with memoization. You can check the previous article [Dynamic Programming Pattern Explained](</en/algo/essential-technique/dynamic-programming-framework/>) to see how to write the iterative version with a `dp` array.
