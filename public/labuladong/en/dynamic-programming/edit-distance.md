...
![](/images/algo/editDistance/edit.gif)

![](/images/algo/editDistance/1-en.jpg)
...
![](/images/algo/editDistance/2.jpg)
...
![](/images/algo/editDistance/3-en.jpg)
...
![](/images/algo/editDistance/insert.gif)
...
![](/images/algo/editDistance/delete.gif)
...
![](/images/algo/editDistance/replace.gif)
...
![](/images/algo/editDistance/dp.jpg)
            ...
            for (int i = 1; i <= m; i++)
                for (int j = 1; j <= n; j++)
                    if (s1.charAt(i - 1) == s2.charAt(j - 1))
                        ...
                        dp[i][j] = min(
                            dp[i - 1][j] + 1, ![](/images/algo/editDistance/delete.gif)
                            dp[i][j - 1] + 1, ![](/images/algo/editDistance/insert.gif)
                            dp[i - 1][j - 1] + 1![](/images/algo/editDistance/replace.gif)
                        );
...
![](/images/algo/editDistance/4-en.jpg)
...
![](/images/algo/editDistance/5-en.jpg)
...
![](/images/algo/editDistance/6-en.jpg)
