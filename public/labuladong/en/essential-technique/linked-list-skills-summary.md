    ...
    class Solution {
        public ListNode detectCycle(ListNode head) {
            ...
            while (fast != null && fast.next != null) {
                fast = fast.next.next;
                slow = slow.next;
                if (fast == slow) break; ![](/images/algo/linked-two-pointer/3-en.jpeg)
            }
            ...
            slow = head; ![](/images/algo/linked-two-pointer/2-en.jpeg)
...
![](/images/algo/linked-two-pointer/3-en.jpeg)
...
![](/images/algo/linked-two-pointer/2-en.jpeg)
