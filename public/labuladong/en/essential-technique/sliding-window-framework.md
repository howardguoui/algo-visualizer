...
CC++GoJavaJavaScriptPython
    ...
    class Solution {
        public String minWindow(String s, String t) {
            ...
            int left = 0, right = 0; ![](/images/algo/slidingwindow/1-en.png)
            int valid = 0;
            ...
            while (right < s.length()) {
                ...
                while (valid == need.size()) { ![](/images/algo/slidingwindow/2-en.png)
