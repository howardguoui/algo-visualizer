...
![diagram](https://labuladong.online/images/algo/linux-fs/desktop.png)

Let's get back to the topic. This article introduces the Linux file system. I will explain what these folders are used for.

![diagram](https://labuladong.online/images/algo/linux-fs/linux-filesystem.png)
...
![diagram](https://labuladong.online/images/algo/linux-fs/bin.png)
...
![diagram](https://labuladong.online/images/algo/linux-fs/sbin.png)
...
![diagram](https://labuladong.online/images/algo/linux-fs/boot.png)
...
![diagram](https://labuladong.online/images/algo/linux-fs/dev.png)
...
![diagram](https://labuladong.online/images/algo/linux-fs/etc.png)

In `/etc/apt`, you can find settings like the mirror list (I have set Aliyun mirror):

![diagram](https://labuladong.online/images/algo/linux-fs/apt.png)
...
![diagram](https://labuladong.online/images/algo/linux-fs/opt.png)
...
![diagram](https://labuladong.online/images/algo/linux-fs/proc.png)
...
![diagram](https://labuladong.online/images/algo/linux-fs/cpu.png)
...
![diagram](https://labuladong.online/images/algo/linux-fs/tmp.png)
...
![diagram](https://labuladong.online/images/algo/linux-fs/usr.png)
...
![diagram](https://labuladong.online/images/algo/linux-fs/usrbin.png)
...
![diagram](https://labuladong.online/images/algo/linux-fs/application.png)
...
![diagram](https://labuladong.online/images/algo/linux-fs/log.png)
...
![diagram](https://labuladong.online/images/algo/linux-fs/home.png)
