  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-10">
      ...
      <div className="text-center mb-14">
        ...
        <div className="flex items-center justify-center gap-6 mt-6 text-sm text-gray-400 dark:text-slate-500">
      ...
      {/* Algorithm Study Note Banner */}
      <div className="mb-10 p-6 bg-indigo-50 dark:bg-gradient-to-r dark:from-indigo-900/40 dark:to-slate-900 rounded-2xl border border-indigo-200 dark:border-indigo-800/40">
          ...
          <div className="flex-1">
            ...
            <div className="flex gap-3 flex-wrap">
              ...
              <Link
                ...
                className="px-4 py-2 bg-gray-200 dark:bg-slate-800 hover:bg-gray-300 dark:hover:bg-slate-700 text-gray-800 dark:text-slate-200 rounded-lg font-medium text-sm transition-colors no-underline"
              >
                {t('Problem Sets', '题单')}
              </Link>
            </div>
        ...
        <div className="flex flex-wrap gap-2 mt-4">
          {studyNoteChapters.map(ch => (
            <Link
              ...
              className="flex items-center gap-1.5 px-3 py-1 bg-white dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700 rounded-full text-xs text-gray-700 dark:text-slate-300 no-underline transition-colors border border-gray-200 dark:border-transparent"
            >
              <span>{ch.icon}</span>
              <span>{ch.label}</span>
            </Link>
