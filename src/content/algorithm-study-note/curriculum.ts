 ...
 *
 * Chapter structure mirrors labuladong.online/zh/algo/ nav exactly:
 *   1. 本站简介
 *   2. 针对初学和速成的学习规划
 *   3. 配套学习工具使用指南
 *   4. 入门：编程语言基础及练习
...
export interface StudyNoteChapter {
  id: string
  label: string                   // e.g. "Chapter 0" or "" for intro chapters
  title: { en: string; zh: string }
  icon: string
...
export const studyNoteChapters: StudyNoteChapter[] = [
  ...
  // ── 1. 本站简介 ─────────────────────────────────────────────────────────────
  {
    ...
    label: '',
    icon: '🏠',
    title: { en: 'Site Introduction', zh: '本站简介' },
    sections: [
      {
        id: 'lb-sec-site-intro',
        title: { en: 'Overview', zh: '概述' },
        articles: [
  ...
  // ── 2. 针对初学和速成的学习规划 ──────────────────────────────────────────────
  {
    ...
    label: '',
    icon: '🗺️',
    title: { en: 'Learning Plans', zh: '针对初学和速成的学习规划' },
    sections: [
      {
        id: 'lb-sec-plans',
        title: { en: 'Plans', zh: '学习规划' },
        articles: [
  ...
  // ── 3. 配套学习工具使用指南 ──────────────────────────────────────────────────
  {
    ...
    label: '',
    icon: '🔧',
    title: { en: 'Learning Tools Guide', zh: '配套学习工具使用指南' },
    sections: [
      {
        id: 'lb-sec-tools',
        title: { en: 'Tools', zh: '工具' },
        articles: [
          { id: 'lb-tool-ai',        zhPath: 'intro/ai-assistant', title: { en: 'AI Teaching Assistant',  zh: 'AI 助教答疑' } },
          { id: 'lb-tool-visualize', zhPath: 'intro/visualize',    title: { en: 'Visualizer Panel Guide', zh: '算法可视化面板' } },
          { id: 'lb-tool-game',      zhPath: 'intro/game',         title: { en: 'Algorithm Games',        zh: '算法游戏汇总' } },
          { id: 'lb-tool-chrome',    zhPath: 'intro/chrome',       title: { en: 'Chrome Plugin',          zh: 'Chrome 刷题插件' } },
          { id: 'lb-tool-vscode',    zhPath: 'intro/vscode',       title: { en: 'VSCode Plugin',          zh: 'VSCode 刷题插件' } },
          { id: 'lb-tool-jetbrains', zhPath: 'intro/jetbrains',    title: { en: 'JetBrains Plugin',       zh: 'JetBrains 刷题插件' } },
          { id: 'lb-lang-acm',       zhPath: 'intro/acm-mode',     title: { en: 'ACM Mode Templates',     zh: 'ACM 模式代码模板' } },
          { id: 'lb-site-vip',       zhPath: 'intro/site-vip',     title: { en: 'Site Membership',        zh: '本站付费会员' } },
        ],
      },
    ],
  },
  ...
  // ── 4. 入门：编程语言基础及练习 ───────────────────────────────────────────────
  {
    ...
    label: '',
    icon: '💻',
    title: { en: 'Language Basics & Practice', zh: '入门：编程语言基础及练习' },
    sections: [
      {
        id: 'lb-sec-lang-overview',
        title: { en: 'Overview', zh: '导读' },
        articles: [
          { id: 'lb-intro-lang-overview', zhPath: 'intro/programming-language-basic', title: { en: 'Language Basics Overview', zh: '编程语言基础导读' } },
        ],
      },
      {
        id: 'lb-sec-lang-c',
        title: { en: 'C Language', zh: 'C 语言' },
        articles: [
      ...
      {
        id: 'lb-sec-lang-js',
        title: { en: 'JavaScript', zh: 'JavaScript' },
        articles: [
          { id: 'lb-lang-js', zhPath: 'intro/js', title: { en: 'JavaScript Basics', zh: 'JavaScript 语言基础' } },
        ],
      },
      {
        id: 'lb-sec-lang-leetcode',
        title: { en: 'LeetCode', zh: 'LeetCode' },
        articles: [
  ...
  // ── 5. 基础：数据结构及排序精讲 ───────────────────────────────────────────────
  {
    ...
    sections: [
      {
        id: 'lb-found-intro',
        title: { en: 'Chapter Introduction', zh: '本章导读' },
        articles: [
          { id: 'lb-intro-ds',        zhPath: 'intro/data-structure-basic', title: { en: 'Data Structures Overview',  zh: '数据结构入门导读' } },
          { id: 'lb-complexity-basic', zhPath: 'intro/complexity-basic',    title: { en: 'Time & Space Complexity',   zh: '时间与空间复杂度' } },
        ],
      },
      {
        id: 'lb-found-array-impl',
        title: { en: 'Dynamic Array Implementation', zh: '手把手带你实现动态数组' },
        articles: [
      ...
      {
        id: 'lb-found-linkedlist-impl',
        title: { en: 'Linked List Implementation', zh: '手把手带你实现单/双链表' },
        articles: [
      ...
      {
        id: 'lb-found-array-variants',
        title: { en: 'Array & Linked List Variants', zh: '数组链表的种种变换' },
        articles: [
      ...
      {
        id: 'lb-found-queue-impl',
        title: { en: 'Queue & Stack Implementation', zh: '手把手带你实现队列/栈' },
        articles: [
      ...
      {
        id: 'lb-found-hash-impl',
        title: { en: 'Hash Table Implementation', zh: '哈希表的原理及实现' },
        articles: [
      ...
      {
        id: 'lb-found-hash-variants',
        title: { en: 'Hash Table Variants', zh: '哈希表结构的种种变换' },
        articles: [
      ...
      {
        id: 'lb-found-tree-structure',
        title: { en: 'Binary Tree Structure & Traversal', zh: '二叉树结构及遍历' },
        articles: [
      ...
      {
        id: 'lb-found-tree-variants',
        title: { en: 'Binary Tree Variants', zh: '二叉树结构的种种变换' },
        articles: [
          { id: 'lb-tree-map-basic',        zhPath: 'data-structure-basic/tree-map-basic',        title: { en: 'TreeMap Basics',             zh: 'TreeMap 基础' } },
          { id: 'lb-tree-map-implement',    zhPath: 'data-structure-basic/tree-map-implement',    title: { en: 'TreeMap Implementation',     zh: 'TreeMap 实现' } },
      ...
      {
        id: 'lb-found-graphs',
        title: { en: 'Graph Structure & Algorithm Overview', zh: '图结构基础及算法概览' },
        articles: [
      ...
      {
        id: 'lb-found-sorting',
        title: { en: 'Ten Sorting Algorithms', zh: '十大排序算法原理及可视化' },
        articles: [
          { id: 'lb-intro-sorting', zhPath: 'intro/sorting',                         title: { en: 'Sorting Intro Guide', zh: '排序算法入门导读' } },
  ...
  // ── 6. 第零章、核心刷题框架汇总 ────────────────────────────────────────────────
  {
    ...
    sections: [
      {
        id: 'lb-ch0-core',
        title: { en: 'Core Frameworks', zh: '核心框架' },
        articles: [
          { id: 'lb-core-intro',       zhPath: 'intro/core-intro',                                      title: { en: 'Chapter Introduction',          zh: '本章导读' } },
          { id: 'lb-algorithm-summary',zhPath: 'essential-technique/algorithm-summary',                 title: { en: 'Algorithm Thinking Framework',   zh: '学习算法和刷题的框架思维' } },
      ...
      {
        id: 'lb-ch0-extended',
        title: { en: 'Extended Techniques', zh: '进阶扩展' },
        articles: [
          { id: 'lb-linked-list-skills-2', zhPath: 'essential-technique/linked-list-skills-summary-2',   title: { en: 'Linked List Techniques – Part II',   zh: '链表算法技巧汇总（二）' } },
          { id: 'lb-array-two-pointers-2', zhPath: 'essential-technique/array-two-pointers-summary-2',   title: { en: 'Two Pointers – Part II',             zh: '双指针技巧汇总（二）' } },
          { id: 'lb-sliding-window-2',     zhPath: 'essential-technique/sliding-window-framework-2',     title: { en: 'Sliding Window – Part II',           zh: '滑动窗口框架（二）' } },
          { id: 'lb-binary-tree-fw-2',     zhPath: 'essential-technique/binary-tree-summary-2',          title: { en: 'Binary Tree Framework – Part II',   zh: '二叉树心法汇总（二）' } },
          { id: 'lb-backtrack-fw-2',       zhPath: 'essential-technique/backtrack-framework-2',          title: { en: 'Backtracking Framework – Part II',  zh: '回溯算法框架（二）' } },
  ...
  // ── 7. 第一章、经典数据结构算法 ─────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        articles: [
          { id: 'lb-intro-bt-practice', zhPath: 'intro/binary-tree-practice',                             title: { en: 'Binary Tree Practice Guide',    zh: '二叉树刷题指南' } },
          ...
          { id: 'lb-huffman-impl',      zhPath: 'data-structure/huffman-tree-implementation',             title: { en: 'Huffman Tree Implementation',   zh: '哈夫曼树代码实现' } },
        ],
      },
      {
        id: 'lb-ch1-bst',
      ...
      {
        id: 'lb-ch1-sorting',
        title: { en: 'Sorting in Practice', zh: '排序算法实战' },
        articles: [
          { id: 'lb-merge-sort-practice', zhPath: 'practice-in-action/merge-sort', title: { en: 'Merge Sort Practice', zh: '归并排序实战' } },
          { id: 'lb-quick-sort-practice', zhPath: 'practice-in-action/quick-sort', title: { en: 'Quick Sort Practice',  zh: '快速排序实战' } },
        ],
      },
    ],
  },
  ...
  // ── 8. 第二章、经典暴力搜索算法 ─────────────────────────────────────────────────
  {
    ...
    label: 'Chapter 2',
    icon: '🔍',
    title: { en: 'Classic Brute-Force Search Algorithms', zh: '第二章、经典暴力搜索算法' },
    sections: [
      {
        id: 'lb-ch2-backtrack',
  ...
  // ── 9. 第三章、经典动态规划算法 ─────────────────────────────────────────────────
  {
    ...
    label: 'Chapter 3',
    icon: '💡',
    title: { en: 'Classic Dynamic Programming Algorithms', zh: '第三章、经典动态规划算法' },
    sections: [
      {
  ...
  // ── 10. 第四章、其他常见算法技巧 ────────────────────────────────────────────────
  {
    ...
    label: 'Chapter 4',
    icon: '🛠️',
    title: { en: 'Other Common Algorithm Techniques', zh: '第四章、其他常见算法技巧' },
    sections: [
      {
        id: 'lb-ch4-greedy',
        ...
        articles: [
          ...
          { id: 'lb-cut-video',      zhPath: 'frequency-interview/cut-video',               title: { en: 'Video Cut Problem',                    zh: '剪视频（区间覆盖）' } },
        ],
      },
      {
        id: 'lb-ch4-math',
      ...
      },
      {
        ...
        articles: [
          ...
          { id: 'lb-cs-linux-process', zhPath: 'other-skills/linux-process',                       title: { en: 'Linux Process Management',  zh: 'Linux 进程管理' } },
          { id: 'lb-cs-linux-pipeline',zhPath: 'other-skills/linux-pipeline',                      title: { en: 'Linux Pipelines',           zh: 'Linux 管道' } },
          { id: 'lb-cs-session-cookie',zhPath: 'other-skills/session-and-cookie',                  title: { en: 'Session & Cookie',          zh: 'Session 与 Cookie' } },
          { id: 'lb-cs-lsm',           zhPath: 'other-skills/lsm-tree',                            title: { en: 'LSM Tree',                  zh: 'LSM 树' } },
          { id: 'lb-cs-cert-ca',       zhPath: 'computer-science/certificate-and-ca',               title: { en: 'Certificate & CA',          zh: '证书与 CA' } },
          { id: 'lb-cs-mtls',          zhPath: 'computer-science/mtls',                             title: { en: 'Mutual TLS (mTLS)',          zh: '双向 TLS（mTLS）' } },
          { id: 'lb-cs-oidc',          zhPath: 'computer-science/oidc',                             title: { en: 'OIDC Protocol',             zh: 'OIDC 协议' } },
          { id: 'lb-cs-pkce',          zhPath: 'computer-science/pkce',                             title: { en: 'PKCE OAuth Flow',           zh: 'PKCE 认证流程' } },
          { id: 'lb-cs-frontend',      zhPath: 'computer-science/frontend-introduction',            title: { en: 'Frontend Introduction',     zh: '前端基础简介' } },
        ],
      },
      {
        id: 'lb-ch4-patterns',
        ...
        articles: [
          ...
          { id: 'lb-dp-bridge',    zhPath: 'design-pattern/bridge',          title: { en: 'Bridge',          zh: '桥接模式' } },
          { id: 'lb-dp-composite', zhPath: 'design-pattern/composite',       title: { en: 'Composite',       zh: '组合模式' } },
          { id: 'lb-dp-prototype', zhPath: 'design-pattern/prototype',       title: { en: 'Prototype',       zh: '原型模式' } },
        ],
      },
    ],
  },
