...
## ¶2024/1/7
  ...
  * 模仿 IDE 代码调试的实用体验，优化可视化面板的代码显示效果：注释用灰色表示，已完成执行的代码用暗黄色显示，当前执行到的代码用绿色高亮显示，还未执行到的代码用白色显示。 ![](/images/algo/changelog/editor-code-color.jpg)

  * 支持双链表的可视化。 ![](/images/algo/visualize_intro/editor-double-list.jpg)
