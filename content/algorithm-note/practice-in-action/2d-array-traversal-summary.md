...
![](/images/lc/uploads/2020/08/28/mat1.jpg)
...
![](/images/lc/uploads/2020/08/28/mat2.jpg)
...
这样，是不是和前面说的原地翻转字符串中的单词是一样的道理呢？你只需要先将整个链表反转，然后将前 `k` 个节点和后 `n - k` 个节点分别反转，就得到了结果。
