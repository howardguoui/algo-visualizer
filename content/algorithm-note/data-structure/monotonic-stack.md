...
LeetCode| 力扣| 难度  
---|---|---  
[496\. Next G$Element I](<https://leetcode.com/problems/next-g$-element-i/>)| [496\. 下一个更大元素 I](<https://leetcode.cn/problems/next-greater-element-i/>)|   
[739\. Daily Temperatures](<https://leetcode.com$[739\. 每日温度](<https://leetcode.cn$   
[503\. Next G$Element II](<https://leetcode.com/problems/next-g$-element-ii/>)| [503\. 下一个更大元素 II](<https://leetcode.cn/problems/next-greater-element-ii/>)|   
$038. 每日温度](<https://leetcode.com/problems/iIQa4I/>)|$ 038. 每日温度](<https://leetcode.cn/problems/iIQa4I/>)|   
...
![](/images/algo/monotonic-stack/1.jpeg)
...
这道题给你输入两个数组 `nums1` 和 `nums2`，让你求 `nums1` 中的元素在 `nums2` 中的下一个更大元素，函数签名如下：
    ...
    $nextGreaterElement(int[] nums1,$ nums2);

其实和把我们刚才的代码改一改就可以解决这道题了，因为题目说 `nums1` 是 `$的子集，那么我们先把 `$ 中每个元素的下一个更大元素算出来存到一个映射里，然后再让 `nums1` 中的元素去查表即可：


    class Solution {
        public $nextGreaterElement(int[] nums1,$ nums2) {
...
![](/images/algo/monotonic-stack/2.jpeg)
