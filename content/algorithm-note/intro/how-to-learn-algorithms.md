...
「**数据结构** 」这部分相对简单，一般只会在面试中考察。比如面试官问你哈希表的原理是什么，为什么它的增删查改效率是 $O(1)$，以及一系列的追问。这种问题类似于八股文，你只要认真学习理解过，都比较容易回答。
...
$100% 会出现在笔试中，属于硬指标，过不了的话面试都没机会。大部分面试中，面试官也可能让你现场$，不过相对来说会容易一些，因为实在不行你可以跟面试官交流嘛。
