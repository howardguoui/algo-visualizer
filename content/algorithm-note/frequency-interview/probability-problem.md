...
> Source: https://labuladong.online/zh/algo/frequency-interview/probability-problem/
...
上篇文章 [谈谈游戏中的随机算法](</zh/algo/frequency-interview/random-algorithm/>) 讲到了验证概率算法的蒙特卡罗方法，今天聊点轻松的内容：几个和概率相关的有趣问题。
...
那为什么只要 23 个人出现相同生日的概率就能大于 50% 了呢？我们先计算 23 个人生日都唯一（不重复）的概率。只有 1 个人的时候$`365/365`，2 个人时$ `365/365 × 364/365`，以此类推可知 23 人的生日都唯一的概率：
